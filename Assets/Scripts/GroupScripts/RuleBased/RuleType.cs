...
namespace ZeroFour.RuleBased
{
    public class RuleType
    {
        ...
        public RuleType(string conditionA, string conditionB, Type result, Predicate compare)
        {
        ...
        public RuleType(string conditionA, string conditionB, string conditionC, Type result, Predicate compare)
        {
            this.conditionA = conditionA;
            this.conditionB = conditionB;
        ...
        public RuleType(string conditionA, string conditionB, string conditionC, string conditionD, Type result, Predicate compare)
        {
            this.conditionA = conditionA;
            this.conditionB = conditionB;
            this.conditionC = conditionC;
